...
//Driver Unavailable more than constant hrs // 1008
public class SimpleAlert1008 extends SimpleAlert {
    public static Integer alertTypeId = 1008;
    ...
    public String getRemark(Master master, Issues issues)  {
        ...
        remarked = "Driver Unavailable more than "+DateAndTime.convertMinutesToDayHoursMinutes(minDuration) + " Hours";
        return remarked;
    }
    ...
    public Boolean isValidAlert(Master master, Issues issues)  {
        ...
        if(master.getSecStatus().equals(SecStatusEnum.DRIVER_UNAVAILABLE.getValue()) && (minuteDiff > minDuration)){
            return true;
        }
        else {
            return false;
