...
//Unloading Delay more than constant hrs // 1004
public class SimpleAlert1004 extends SimpleAlert {
    public static Integer alertTypeId = 1004;
    ...
    public String getRemark(Master master, Issues issues)  {
        ...
        remarked = "Unloading Delay more than "+DateAndTime.convertMinutesToDayHoursMinutes(minDuration) + " Hours";
        return remarked;
    }
    ...
    public Boolean isValidAlert(Master master, Issues issues)  {
        ...
        if(master.getPrimStatus().equals(PrimStatusEnum.UNLOADING.getValue()) && (minuteDiff > minDuration) && minuteDiff < (3*24*60)){ // minuteDiff is less than 3 days(in min)
            return true;
        }
        else {
            return false;
