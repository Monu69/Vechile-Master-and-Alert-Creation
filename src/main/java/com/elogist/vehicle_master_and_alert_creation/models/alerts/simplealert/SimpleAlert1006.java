...
//Long Breakdown more than constant hrs // 1006
public class SimpleAlert1006 extends SimpleAlert {
    public static Integer alertTypeId = 1006;
    ...
    public String getRemark(Master master, Issues issues)  {
        ...
        remarked = "Long Breakdown more than "+DateAndTime.convertMinutesToDayHoursMinutes(minDuration) + " Hours";
        return remarked;
    }
    ...
    public Boolean isValidAlert(Master master, Issues issues)  {
        ...
        if(master.getSecStatus().equals(SecStatusEnum.BREAK_DOWN.getValue()) && (minuteDiff > minDuration)){
            return true;
        }
        else {
            return false;
