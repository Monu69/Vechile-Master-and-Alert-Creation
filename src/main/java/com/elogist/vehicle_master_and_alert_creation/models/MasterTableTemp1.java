...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "master_vehicle_temp1")
@TypeDefs({
        @TypeDef(
                name = "long-array",
...
public class MasterTableTemp1 extends Master{
    ...
    // last non future state Latitude
    @Column(name = "vs_lat")
...
//    private List<Integer> currentUlSite;
    ...
    @Transient
    private MasterTableTemp2 masterTableTemp2;

    @Transient
    private MasterRouteTempR1R2DTO masterRouteTempR1R2DTO;

    @Transient
    private MasterDynamicRouteTemp12 masterDynamicDynamicRouteTemp12;

    public MasterRoute getMasterRoute(){

        return this.masterRouteTempR1R2DTO;

    }

    public MasterDynamicRoute getMasterDynamicRoute(){

        return this.masterDynamicDynamicRouteTemp12;
