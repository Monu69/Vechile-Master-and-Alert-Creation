...
public class AEHAPI30573AE1 extends AlertEventHandler {
    ...
    @Value("${alert.fo30573.AEHAPI30573AE1.apiType}")
    private String apiType;

    @Value("${alert.fo30573.AEHAPI30573AE1.foAdminId}")
    ...
    public Boolean isTriggered(MasterTableTemp1 master){
        ...
        try {
            ...
            if (feignResult.get("data") != null && mtrData.size() > 0) {
                mtrData.get(0).put("EventName","TRIP_COMPLETE");
                ...
                response = "MTR Data not fetched for tripId-->" + " " + master.getVtId() + " vehicleId-->" + master.getVId() + " " + " foAdminId-->" + foAdminId;
            }
        }
        catch (Exception e){
